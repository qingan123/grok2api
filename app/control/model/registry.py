...
MODELS: tuple[ModelSpec, ...] = (
    ...
    ModelSpec("grok-4.3",                               ModeId.FAST,     Tier.BASIC, Capability.CONSOLE_CHAT, True, "Grok 4.3 High"),
    ModelSpec("grok-4.3-high",                          ModeId.FAST,     Tier.BASIC, Capability.CONSOLE_CHAT, True, "Grok 4.3 High"),
